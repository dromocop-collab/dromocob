...
const fallbackQuestions: QuoteQuestion[] = [
  ...
  { id: "web-goal", key: "webGoal", title: "Web sitenin öncelikli iş hedefi ne?", subtitle: "Tasarımı değil, oluşturacağımız sistemi belirler.", type: "single", active: true, order: 2, serviceTypes: ["web", "software"], options: [
  ...
  { id: "web-scope", key: "webScope", title: "İçerik ve sayfa kapsamı ne kadar geniş?", type: "single", active: true, order: 3, serviceTypes: ["web", "software"], options: [
  ...
  { id: "web-capabilities", key: "webCapabilities", title: "Sistemde hangi yetenekler olmalı?", subtitle: "İhtiyacın olan tüm modülleri seçebilirsin.", type: "multi", active: true, order: 4, serviceTypes: ["web", "software"], options: [
  ...
  { id: "web-content", key: "webContent", title: "İçerik üretiminde nasıl ilerleyelim?", type: "single", active: true, order: 5, serviceTypes: ["web", "software"], options: [
  ...
  { id: "video-format", key: "videoFormat", title: "Nasıl bir video paketi planlıyoruz?", subtitle: "Prodüksiyon ekibi ve anlatım dili buna göre şekillenir.", type: "single", active: true, order: 2, serviceTypes: ["video"], options: [
  ...
  { id: "video-output", key: "videoOutput", title: "Teslim paketinde kaç ana video olsun?", type: "single", active: true, order: 3, serviceTypes: ["video"], options: [
  ...
  { id: "video-production", key: "videoProduction", title: "Çekim ölçeği nasıl olmalı?", type: "single", active: true, order: 4, serviceTypes: ["video"], options: [
  ...
  { id: "video-extras", key: "videoExtras", title: "Prodüksiyona hangi katmanları ekleyelim?", subtitle: "Birden fazla seçebilirsin.", type: "multi", active: true, order: 5, serviceTypes: ["video"], options: [
...
export default function QuoteWizard({ open, onClose }: { open: boolean; onClose(): void }) {
  ...
  useEffect(() => {
    fetchQuoteEngine().then(data => {
      ...
      const isLegacyQuestionSet = databaseKeys.has("service") && databaseKeys.has("extras") && data.questions.length <= 4;
