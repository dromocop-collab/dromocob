...
import { BarChart3, Boxes, CircleGauge, Command, ExternalLink, FolderKanban, Globe2, KeyRound, LogOut, Mail, Menu, MessageSquare, Package, RadioTower, Rocket, Settings2, Sparkles, X } from "lucide-react";
