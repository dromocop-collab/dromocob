...
const websiteCaseStudies: ProjectCaseStudy[] = [
  {
    ...
    slug: "senin-randevun",
    title: "SeninRandevun",
    seoTitle: "SeninRandevun Online Randevu ve İşletme Yönetim Platformu",
    category: "SaaS · Web & iOS",
    eyebrow: "Online randevu · Çoklu mağaza · Mobil uygulama",
    year: 2026,
    summary: "Müşteri keşfinden uygun saat seçimine; işletme takviminden ekip, hizmet ve çoklu mağaza yönetimine kadar bütün randevu operasyonunu tek üründe buluşturan SaaS platformu.",
    description: "SeninRandevun; müşterilere hızlı işletme ve hizmet keşfi, işletmelere ise web ve iOS üzerinden randevu, ekip, müşteri, hizmet ve mağaza operasyonu sunan yeni nesil online randevu sistemi.",
    coverUrl: "/images/projects/senin-randevun.svg",
    coverAlt: "SeninRandevun web ve iOS online randevu platformu arayüzleri",
    service: "Ürün stratejisi, UX/UI, web uygulaması ve iOS geliştirme",
    location: "Türkiye geneli",
    challenge: "Farklı kategorilerdeki işletmelerin müsaitlik, hizmet, ekip ve müşteri yönetimini sadeleştirirken kullanıcıların doğru işletmeyi bulup güvenle randevu alabileceği ortak bir deneyim kurmak.",
    solution: "Keşif ve rezervasyon deneyimi; işletme operasyon paneli, çoklu mağaza yapısı, rol bazlı yönetim ve mobil uygulamayla aynı veri modeli üzerinde birleştirildi. Böylece müşteri ve işletme tarafı birbirini gerçek zamanlı besleyen tek ürüne dönüştü.",
    outcomes: [
      "Web ve iOS'ta tutarlı uçtan uca randevu deneyimi",
      "Hizmet, ekip, takvim ve müşteriyi birleştiren işletme merkezi",
      "Farklı sektör ve çoklu mağaza yapılarına uyarlanabilir SaaS mimarisi",
    ],
    services: [
      "Ürün stratejisi ve bilgi mimarisi",
      "Müşteri keşif ve rezervasyon akışı",
      "İşletme ve süper yönetim panelleri",
      "Çoklu mağaza ve rol yönetimi",
      "Native iOS uygulaması",
      "Teknik SEO, analitik ve yapılandırılmış veri",
    ],
    process: [
      { title: "Ürün haritası", description: "Müşteri, işletme ve platform yöneticisinin ihtiyaçları tek servis haritasında birleştirildi." },
      { title: "Deneyim sistemi", description: "Keşif, mağaza, hizmet, uzman ve uygun saat akışları mobil öncelikli olarak tasarlandı." },
      { title: "Platform geliştirme", description: "Web, iOS, yönetim panelleri ve ortak veri modeli ölçeklenebilir modüller hâlinde geliştirildi." },
      { title: "Yayın ve büyüme", description: "SEO, ölçüm, güvenlik ve yayın kontrolleriyle ürünün sürdürülebilir büyüme altyapısı kuruldu." },
    ],
    deliverables: [
      "Müşteri odaklı keşif ve randevu web uygulaması",
      "İşletme operasyon ve yönetim paneli",
      "Native iOS müşteri ve işletme deneyimi",
      "Hizmet, kategori ve uygunluk motoru",
      "Çoklu mağaza ve yetkilendirme altyapısı",
      "SEO, analitik ve bildirim entegrasyonları",
    ],
    relatedServiceUrl: "/mobil-uygulama",
    relatedServiceLabel: "Mobil uygulama ve SaaS geliştirme hizmetini incele",
    liveUrl: "https://seninrandevun.com",
    keywords: [
      "SeninRandevun",
      "online randevu sistemi",
      "işletme randevu programı",
      "randevu uygulaması",
      "iOS randevu uygulaması",
      "çoklu mağaza yönetimi",
      "SaaS yazılım projesi",
    ],
    faq: [
      { question: "SeninRandevun hangi işletmeler için geliştirildi?", answer: "Güzellik, bakım, sağlık, danışmanlık, spor, veteriner, yazılım ve randevuyla çalışan farklı hizmet kategorilerindeki işletmelere uyarlanabilen bir altyapı sunar." },
      { question: "Platform yalnızca web üzerinden mi çalışıyor?", answer: "Hayır. Müşteri ve işletme deneyimi web ile native iOS uygulamasında ortak ürün ve veri mimarisi üzerinde çalışır." },
      { question: "Bir hesap birden fazla mağazayı yönetebilir mi?", answer: "Evet. Platform, yetki ve onay akışlarıyla birden fazla mağazanın aynı hesap altında yönetilebildiği bir yapı için tasarlanmıştır." },
    ],
  },
  {
