...
const DEFAULT_SETTINGS: SiteSettings = {
  ...
  seo: {
    siteName: "Dromocob",
    defaultTitle: "Kurumsal Web Sitesi ve Video Prodüksiyon | Türkiye",
    titleTemplate: "%s | Dromocob",
    defaultDescription: "Fethiye merkezli Dromocob; markalar için sinematik film prodüksiyonu, yüksek performanslı web ürünleri, SEO ve ölçülebilir büyüme sistemleri geliştirir.",
    keywords: ["kurumsal web sitesi", "video prodüksiyon", "dijital büyüme"],
    canonicalUrl: "https://dromocob.tr",
    ogImage: "https://dromocob.tr/opengraph-image",
