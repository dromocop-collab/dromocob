...
export const metadata = pageMetadata({
  ...
  keywords: ["web sitesi tasarımı", "web sitesi yaptırma", "kurumsal web sitesi", "kurumsal tanıtım sitesi", "web tasarım ajansı", "web yazılım ajansı", "e-ticaret sitesi yaptırma", "özel web yazılım", "İstanbul web tasarım", "Türkiye web tasarım", "Next.js ajansı", "SEO uyumlu web sitesi"],
});
...
export default function WebDesignPage() {
  return <ServiceLanding quoteService="web" path="/hizmetler/web-tasarim" breadcrumbLabel="Web Tasarım" eyebrow="Web sitesi tasarımı · Web yazılım · Türkiye" title="Markanı büyüten" accent="web siteleri." intro="Kurumsal tanıtım sitesi, e-ticaret sitesi ve özel web yazılım projelerinde; hızlı açılan, Google tarafından anlaşılabilen ve ziyaretçiyi müşteriye dönüştüren dijital deneyimler tasarlıyoruz." schema={schema} faqs={[
