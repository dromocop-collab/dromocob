...
export default function DromocobUltraPage() {
  return <main className="ultra-product-page">
    ...
    <section className="ultra-product-hero section">
      ...
      <div className="ultra-stats"><article><strong>64</strong><span>Geçiş preseti</span></article><article><strong>10</strong><span>Carousel sistemi</span></article><article><strong>2.7.1</strong><span>Güncel sürüm</span></article><article><strong>TR/EN</strong><span>Çift dil arayüz</span></article></div>
    </section>
