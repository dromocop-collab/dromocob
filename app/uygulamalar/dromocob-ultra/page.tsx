...
export default function DromocobUltraPage() {
  return <main className="ultra-product-page">
    ...
    <section className="ultra-product-hero section">
      ...
      <div className="ultra-hero-grid">
        <div className="ultra-hero-copy">
          ...
          <div className="ultra-hero-actions">
            <a href="/downloads/Dromocob-Ultra-2.5.1.zxp" download><Download /> ZXP’yi indir <span>v2.5.1</span></a>
      ...
      <div className="ultra-stats"><article><strong>10</strong><span>Carousel sistemi</span></article><article><strong>6</strong><span>Üretim modülü</span></article><article><strong>2.5.1</strong><span>Güncel sürüm</span></article><article><strong>TR</strong><span>Türkçe arayüz</span></article></div>
    </section>
    ...
    <section className="ultra-final section"><div><p className="eyebrow">DROMOCOB ULTRA 2.5.1</p><h2>After Effects’i<br /><em>üretim merkezine çevir.</em></h2></div><div><a href="/downloads/Dromocob-Ultra-2.5.1.zxp" download><Download /> İmzalı ZXP’yi indir</a><Link href="/lisans">Lisans Cloud <ArrowRight /></Link></div></section>
  </main>;
}
