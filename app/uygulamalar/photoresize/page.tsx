...
export default function PhotoResizePage() {
  return <><SiteNav/><main className="app-detail-page">
    ...
    <section className="app-final-download section"><div><p className="eyebrow">READY TO RESIZE</p><h2>PhotoResize’i<br/>Mac’ine indir.</h2></div><a href="/downloads/PhotoResize-1.0.1.dmg" download><Download/> Ücretsiz indirilebilir DMG <span>1.0.0</span></a></section>
  </main><SiteFooter/></>;
}
